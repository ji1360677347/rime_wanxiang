...
## [17.3.0](https://github.com/ji1360677347/rime_wanxiang/compare/v17.3.0...v17.3.0) (2026-08-15)
...
* **lua:** add super symbols module based on typst/codex ([7dab289](https://github.com/ji1360677347/rime_wanxiang/commit/7dab2890d493e709c1c545c16e2bbd36f970ff70))
* **super_lookup:** base新增针对两字词组的直接辅助筛选，默认关闭，类似手心的直接辅助选项，但是只提供开关不提供对某个字辅助，因为实践中往往是any，支持任意字的单码、双码，以及两个字首码组成的双码 ([97de6d8](https://github.com/ji1360677347/rime_wanxiang/commit/97de6d84314bb8cf671429ac0a18b88504993714))
* **super_replacer:** 新增针对流水线转换节点中，输入类型的控制参数only_types,exclude_types 可选，解决一直以来一个严重的问题，对于全拼如果匹配简码实际上是在干扰自己本身的简码，所以基本上必须置顶，而双拼则要单字优先简码应该出现在次选或更后面的位置，这一冲突导致默认的1,6前置参数只适用于双拼。第二处修改是当有一个被前置的情形下其他的直接丢弃，避免干扰自然排序被拖到后面，只有在需要完全兜底的情形下三个简码才一次性释放 ([e196220](https://github.com/ji1360677347/rime_wanxiang/commit/e1962207c4c4bf7fab431a7de3711b332e4ae42a))
* **user_predict:** 新增手机捕获前端发送的 delete_notifier，实现点击/手势删词同步清除数据库，克服了手机不易操作shift+del的难点 ([7df2f4e](https://github.com/ji1360677347/rime_wanxiang/commit/7df2f4ea84d03e85049a929158f4eda767afd7ca))
* 万象英文新增replacer，可以使用emoji和翻译为中文的配置 ([3058da5](https://github.com/ji1360677347/rime_wanxiang/commit/3058da53dc77f01ecfaf2807e12fc1fdc501b5db))
* 新增一个句子派生示例 ([914f90e](https://github.com/ji1360677347/rime_wanxiang/commit/914f90ef0eddee72f2e076202126517f8494e8b3))
* 新增蓝天双拼支持，但不支持指令后续支持 ([48f1f49](https://github.com/ji1360677347/rime_wanxiang/commit/48f1f495a9e73b962bba99a3017a55213548943c))
* 新增部分英文提权策略，使用super_replacer实现 ([7a18133](https://github.com/ji1360677347/rime_wanxiang/commit/7a18133d1b1a1a6dcde6db5aa95182d06d547bbd))
* 添加pure版本自动化打包 ([f0bb82d](https://github.com/ji1360677347/rime_wanxiang/commit/f0bb82d04fd3cbeaca76d0214b6d464a218a4f02))
* 添加pure版本自动化打包 ([e195428](https://github.com/ji1360677347/rime_wanxiang/commit/e195428a54d2ad58bf364963e82100f2745c8274))
* 添加大牛双拼 ([2b31fd9](https://github.com/ji1360677347/rime_wanxiang/commit/2b31fd941a3c4b109bfe28c892fef82072f2fb08))
* 用于万象拼音的Linux Compose键模拟 ([e0fc9a1](https://github.com/ji1360677347/rime_wanxiang/commit/e0fc9a12ebf19db576f073509051d235b2f2e79f))
* 英文词库加了词频前面忘记说了，现在英文lua也能帮助在中文状态下输入英文句子了，能正确解构好中文句子和英文句子的删除和留存问题 ([ba44a97](https://github.com/ji1360677347/rime_wanxiang/commit/ba44a97838cc40fb72728a917ea49b06d70b9e35))
* 超级注释新增单音节简码是否转换preedit的设置，并优化preedit代码可读性 ([fdda7af](https://github.com/ji1360677347/rime_wanxiang/commit/fdda7afb218e9643f695ada5ec337ec03762751b))
* 通过仅有的算法资源精准扩展小鹤拆分显示增加1万+ ([b368ee5](https://github.com/ji1360677347/rime_wanxiang/commit/b368ee524b6b1959658f0d14de845d5fa38d70c7))
* 采用融合特征算法，超级替换跨方案也不会造成无修改的重新初始化了 ([7b33c73](https://github.com/ji1360677347/rime_wanxiang/commit/7b33c738c5c4c01b6f914a916069145a05ff9c83))
* 预测新增对S级别的内容进行前缀回退扫描，应对诗句类型的拆句，例如储存数据为：墙角数枝梅，凌寒独自开，输入墙角会补充预测数枝梅，选择后整体还能匹配凌寒独自开 ([6192550](https://github.com/ji1360677347/rime_wanxiang/commit/6192550d2e58affb6033e4b36505232706d0cbff))


### 📚 词库更新

* mixed dict update ([25e5568](https://github.com/ji1360677347/rime_wanxiang/commit/25e556801806130add4edab3fc3f6893ae9663c6))
* updat ([d9c7bca](https://github.com/ji1360677347/rime_wanxiang/commit/d9c7bca7dde8f09a447559702e51645d32403aab))
* update ([29ae6d1](https://github.com/ji1360677347/rime_wanxiang/commit/29ae6d17c700c53243ba83ba8a9ce7a61a8df92a))
* update ([38c43ce](https://github.com/ji1360677347/rime_wanxiang/commit/38c43ce8d9779e850e540419500a96ca2aca2b8e))
* update ([b7063d0](https://github.com/ji1360677347/rime_wanxiang/commit/b7063d02f30a2a4b54e3321c3d5e42bb6ca0f9f8))
* update ([210e058](https://github.com/ji1360677347/rime_wanxiang/commit/210e058e44dcda2d7283f12731de578dcdbb4f0d))
* 丰富lua键值匹配数据 ([4616851](https://github.com/ji1360677347/rime_wanxiang/commit/461685122005598bdb9d6ce93b2c8df76258ad03))
* 优化多音字 ([186f716](https://github.com/ji1360677347/rime_wanxiang/commit/186f7161ba55ff191a2e204dce3088252a14dc92))
* 优质词补全 ([b255821](https://github.com/ji1360677347/rime_wanxiang/commit/b255821d072e43e9264b52eb6bbb3438e661ba79))
* 分离王姓人名 ([77d68dd](https://github.com/ji1360677347/rime_wanxiang/commit/77d68dd90b35dee74c44c8a2b7a041208c0fdb00))
* 剥离由首选2+2组成的四字词条为单独top词库，且这些词条在词库中没有读音重合，在模型的作用下即使是打四个字也是直出的，保留top也只是短期内的留存共剥离17万 ([10fbb2e](https://github.com/ji1360677347/rime_wanxiang/commit/10fbb2eb8534cebe182f9461cdbcbcf28a332416))
* 变更词典名称 ([83ac39a](https://github.com/ji1360677347/rime_wanxiang/commit/83ac39acb4e3fc2073ba1fc60deb844a9c637e5c))
* 增加姓x的词条 ([855d5df](https://github.com/ji1360677347/rime_wanxiang/commit/855d5df024735b971a1fc210ebb8f841d962cacc))
* 恢复误删除词条 ([3974da1](https://github.com/ji1360677347/rime_wanxiang/commit/3974da1f992b347676dbf61e6ad3bac083a39ce8))
* 扩展地名变种 ([42f7c7d](https://github.com/ji1360677347/rime_wanxiang/commit/42f7c7d2ca61ffca3a8b52001b37af47461252b7))
* 词库调整 ([33e2c7e](https://github.com/ji1360677347/rime_wanxiang/commit/33e2c7eb5bfea31f86b0e9fe32cd08370e8f9403))
* 词库调整 ([e401a65](https://github.com/ji1360677347/rime_wanxiang/commit/e401a65a94c3e1a940ff4a59682ef7dff84603b3))
* 词库调整 ([006f57f](https://github.com/ji1360677347/rime_wanxiang/commit/006f57fa48cc81a04968f06d9f3213c8a838f21f))
* 词库调整 ([6e46107](https://github.com/ji1360677347/rime_wanxiang/commit/6e461075e165a322204ecd17dd09400dba232b01))
* 词库调整 ([6b5f20d](https://github.com/ji1360677347/rime_wanxiang/commit/6b5f20d1fc34ad2139031a1282800f79c588d826))
* 词库调整 ([7453e5f](https://github.com/ji1360677347/rime_wanxiang/commit/7453e5fc5efff37bac828fe2857c131ab370817a))
* 词库调整 ([9d54179](https://github.com/ji1360677347/rime_wanxiang/commit/9d5417917d7f322b70f598703a9999a3cdbc666d))
* 迁移人名 ([098002f](https://github.com/ji1360677347/rime_wanxiang/commit/098002fb8f111a2a844759e396628f304c29932b))
* 进一步归类名称词库 ([907d413](https://github.com/ji1360677347/rime_wanxiang/commit/907d41363fb3e6778f5cc9a7fa7d968367077b9e))


### 🔥 性能优化

* **charset_filter:** 延迟初始化字符集反查库 ([22c60ef](https://github.com/ji1360677347/rime_wanxiang/commit/22c60ef7de9127c6c2d4cdbae8998659f1108a32))
* **force_upper_aux:** 延迟初始化辅助码反查库 ([00f5ba8](https://github.com/ji1360677347/rime_wanxiang/commit/00f5ba8985a39ab566ab84b1a3837dc768809670))
* **input_stats:** 延迟初始化统计数据库 ([7429fb4](https://github.com/ji1360677347/rime_wanxiang/commit/7429fb41e530a0f96a86b1862cf4a3f7b8dd7663))
* **replacer:** 优化数据库初始化与重建流程 ([e369837](https://github.com/ji1360677347/rime_wanxiang/commit/e36983781236d8a1b6c92edde35b1ba3911e9313))
* **sequence:** 延迟同步并优化排序数据导出 ([8d412ff](https://github.com/ji1360677347/rime_wanxiang/commit/8d412ffb5affb06516f428982021b8f16c590fbe))
* **super_lookup:** 延迟初始化反查数据库资源 ([0935878](https://github.com/ji1360677347/rime_wanxiang/commit/093587804b1d6de1530dc059817f5815fedf6233))
* **super_replacer:** optimize active abbrev processing ([5f82993](https://github.com/ji1360677347/rime_wanxiang/commit/5f82993b1ebbf2c64f106afa652d46f5c0d1658b))
* **tips:** 优化数据库初始化与重建流程 ([2e13d9f](https://github.com/ji1360677347/rime_wanxiang/commit/2e13d9fe5554c2bc55d347b4c2a4bc521f837598))
* **user_predict:** 延迟执行预测库过期清理 ([c33a2ab](https://github.com/ji1360677347/rime_wanxiang/commit/c33a2ab48ca72eb983bca8678dc1bad127bcce64))
* 优化超级替换时间复杂度，并写死分隔符为制表符，未来直接使用制表符组织多个选项，自定义用户需手动替换为制表符重新部署 ([0e22026](https://github.com/ji1360677347/rime_wanxiang/commit/0e220265b7e652a538a53e6f01b007562d0fb5f4))
* 移除英文造词功能，此功能在挂接状态下缺乏相应的转写流程，致使只能写入小写字母，写入大写字母无法打出来，终究也是个半成品，其次在table调频的时候与简码派生状态竞争权重干扰中文输入，再三思考还是决定将英文造词去掉，在rime在这种情况下不如自己维护一个词库表来的有意义 ([914611b](https://github.com/ji1360677347/rime_wanxiang/commit/914611b4ea4487fafd4e97b860ecc641878e3081))


### 🐛 Bug 修复

* 1、独立元书九键方案，其他九键使用公共九键方案2、预测在滤镜中引用位置提前3、其他方案细节的一些调整 ([0892970](https://github.com/ji1360677347/rime_wanxiang/commit/089297039f5d488d08d1662c79fd4a1c1165a93f))
* backspace防误删除单独排除鼠须管 ([f87124a](https://github.com/ji1360677347/rime_wanxiang/commit/f87124ac9c7aa0e5a5d33e45c12e12a8c4e95990))
* base,t9移除手动排序 ([57aa072](https://github.com/ji1360677347/rime_wanxiang/commit/57aa0723db41731ad55f066deee9778a8cf203ff))
* config读取default改成了schema直接验证id，对比之前不存在的方案会报W不存在，但相比一些低版本无法使用Config方法要好很多 ([dc56713](https://github.com/ji1360677347/rime_wanxiang/commit/dc56713b0cfef075b0cb256bab66f14a0eeb18a9))
* ctrl+数字上屏时支持先数字选定一段确认的候选接着再去按ctrl+数字，这样已确认部分与后面的部分一起上屏 ([e4830cf](https://github.com/ji1360677347/rime_wanxiang/commit/e4830cfc5f5c3d92bbb76a7168e6121438feb2af))
* drop execution bit on wanxiang_english.{dict,schema}.yaml ([614e1dc](https://github.com/ji1360677347/rime_wanxiang/commit/614e1dc5faa65bf6ae9bfc9e8104b5d83a3c80e5))
* fix ([a9ef6a8](https://github.com/ji1360677347/rime_wanxiang/commit/a9ef6a87a6e269bea9b9f3c9802297e781843d07))
* lookup fix ([345654c](https://github.com/ji1360677347/rime_wanxiang/commit/345654cb485f6caef99f7ed957215e0e07e98d67))
* **lookup:** tab按键将用来同时触发反引号按键用来作为lookup触发按键,同时ctrl+tab用来切换音节，取消了边上屏边切换音节的设计，因为其实大部分情况ctrl+数字的应用可以在不加辅助的情形下完成上屏 ([f06e167](https://github.com/ji1360677347/rime_wanxiang/commit/f06e167ee6481d80aec9794e367ebfd2c0b438a0))
* **lookup:** 优化代码 ([f0b7094](https://github.com/ji1360677347/rime_wanxiang/commit/f0b7094148772c910339b3b2aeda6013598735d7))
* **lookup:** 修复直接辅助前置后后面的所有两个字候选消耗编码不正确的问题 ([38b003a](https://github.com/ji1360677347/rime_wanxiang/commit/38b003a8cf721a35d6ce4b53e02524735ff5b552))
* **lua:** 原生位运算符仅在 Lua 5.3+ 中可用 ([00805dd](https://github.com/ji1360677347/rime_wanxiang/commit/00805dd487a3cbd3f872f658d41dbc1801f32b44))
* mac判断修改错误的声明名称 ([3b65f27](https://github.com/ji1360677347/rime_wanxiang/commit/3b65f271ad831fa6225247ff412c9cd169faa227))
* **replacer:** 修复九键数据加载问题，数据库关闭前gc释放对象 ([8776513](https://github.com/ji1360677347/rime_wanxiang/commit/87765135033fbcd93e415bcb5b1998e6cd0e6fe5))
* **replacer:** 修复若干bug ([59a22a7](https://github.com/ji1360677347/rime_wanxiang/commit/59a22a7ef812af45b2f84d19e55938fb524b3cab))
* replacer错误引用了绝对路径 ([28f678f](https://github.com/ji1360677347/rime_wanxiang/commit/28f678f8bb8cd9a005aebba46b8961b83fc1e464))
* **sequence:** 修复若干bug ([5df7512](https://github.com/ji1360677347/rime_wanxiang/commit/5df751293c10a163d68d31cfc6cf3be289f9bf53))
* **super_english:** 显式释放英文翻译器 ([0ac8758](https://github.com/ji1360677347/rime_wanxiang/commit/0ac8758246b56ce9042b1bb976d9228ffde9d6ce))
* **super_filter:** 减少重复计算与临时分配 ([e9ec1e4](https://github.com/ji1360677347/rime_wanxiang/commit/e9ec1e4d262d44272db80c44235f5809013c8a98))
* **super_lookup:** 修复全拼状态下zhi jie这类输入的情况下e被错误判定为辅助码的问题 ([3fdd2d9](https://github.com/ji1360677347/rime_wanxiang/commit/3fdd2d9a9fcef3ed01228784d58b50ae7194d520))
* **super_peplacer:** 流式加载数据 ([1c4b685](https://github.com/ji1360677347/rime_wanxiang/commit/1c4b685cbd90ab8d9729a1f72ef8360df2370dae))
* **super_replacer:** 优化简繁转换整句转换算法，比fmm更好用 ([4b87425](https://github.com/ji1360677347/rime_wanxiang/commit/4b87425d9a97a5c29407d5cf5b3023a3bc636cb9))
* super_replacer的热路径性能应该是抠到了极致 ([53baa6f](https://github.com/ji1360677347/rime_wanxiang/commit/53baa6ff84ae99d2807a3290a23cecae4bea79f2))
* **super_symbols:** 优化超级符号用户交互 ([e0fc9a1](https://github.com/ji1360677347/rime_wanxiang/commit/e0fc9a12ebf19db576f073509051d235b2f2e79f))
* t9符号引入错误 ([6adbb51](https://github.com/ji1360677347/rime_wanxiang/commit/6adbb514770f373e4e6e41008aec16ca83821693))
* the issue of the delete function not working in Input Cobra Method. ([5988f47](https://github.com/ji1360677347/rime_wanxiang/commit/5988f47223886abbaca6af8e678136012a509866))
* use func field for RIME translator export ([7cf08ef](https://github.com/ji1360677347/rime_wanxiang/commit/7cf08eff2dce607074932e5c1b1a2fbedb440690))
* **user_predict:** 修复若干bug ([2cca1e8](https://github.com/ji1360677347/rime_wanxiang/commit/2cca1e8c437fe48a216480c751df0cdee7ad061a))
* **user_predict:** 修复若干bug ([3a45923](https://github.com/ji1360677347/rime_wanxiang/commit/3a4592332abc12f704401cdb859fa52f37da5908))
* **user_predict:** 外部状态打断状态未更新导致的回退键清空了下一次输入状态 ([15fdb69](https://github.com/ji1360677347/rime_wanxiang/commit/15fdb69f622b3604b737867cb12f12a94c930813))
* **user_predict:** 数据库关闭前gc释放对象 ([14dd4bb](https://github.com/ji1360677347/rime_wanxiang/commit/14dd4bbefb45ec53bda12e6bc6e5abd5cba41274))
* 九宫格续写时数字键不再漏字面数字 ([dfa891b](https://github.com/ji1360677347/rime_wanxiang/commit/dfa891beecac5d2bb16a5d9817b89eb71588c55d))
* 从abbrev分离单码单字，新建了chars，使用前置5个单字的逻辑进行配置 ([2f7a693](https://github.com/ji1360677347/rime_wanxiang/commit/2f7a6937c46cce6c4cc50730d5412354948faa1b))
* 以词定字在特殊输入模式下不占用按键 ([8756409](https://github.com/ji1360677347/rime_wanxiang/commit/87564092e09dbf330db81f57cdab1bafdd2b9789))
* 优化lookup反查速度体验 ([24fbebe](https://github.com/ji1360677347/rime_wanxiang/commit/24fbebedb83cec95ac8564804907e404971170e7))
* 优化lookup直接辅助的性能细节 ([ed4025f](https://github.com/ji1360677347/rime_wanxiang/commit/ed4025f03e9d917517746b339aeed34e3f1ae849))
* 优化lookup表的创建和复用 ([b017fd4](https://github.com/ji1360677347/rime_wanxiang/commit/b017fd4f1e0e7793ef0d78ce48783e3f376367c4))
* 优化replacer lua，移除单字匹配的句子派生 ([351fd04](https://github.com/ji1360677347/rime_wanxiang/commit/351fd048b104c403e80e10a569f9a740d10753e1))
* 优化两个辅助函数 ([00758d8](https://github.com/ji1360677347/rime_wanxiang/commit/00758d8eddf3eb062dbad2ebb603ce92f5c2b7f3))
* 优化双方案的指令切换逻辑 ([e0c8ec3](https://github.com/ji1360677347/rime_wanxiang/commit/e0c8ec353948d1722d271e925ccac122cef5c10e))
* 优化回车以拦截并输出换行 ([bfb8325](https://github.com/ji1360677347/rime_wanxiang/commit/bfb8325a062104808510fee2161efac2cf6efa41))
* 优化字符级过滤中的几个兜底逻辑 ([ce76235](https://github.com/ji1360677347/rime_wanxiang/commit/ce76235147ac90f4377b128efb3062f8c94b799a))
* 优化字符集过滤 ([94b0059](https://github.com/ji1360677347/rime_wanxiang/commit/94b0059501cd7d3f4194bbbcca85fc662d3250a9))
* 优化字符集过滤兜底性能 ([0910f4a](https://github.com/ji1360677347/rime_wanxiang/commit/0910f4a7beeb49b386d5e9c5bde23ea535f4ac01))
* 优化手动排序脚本 ([86a8f51](https://github.com/ji1360677347/rime_wanxiang/commit/86a8f513a55f71589fd46e51e4367f7ec44d95f8))
* 优化文件重复key判断逻辑 ([3513802](https://github.com/ji1360677347/rime_wanxiang/commit/35138023189f1376b4d55363f21b2fc373033729))
* 优化时间调用 ([750dfc6](https://github.com/ji1360677347/rime_wanxiang/commit/750dfc6229a8ef631ebee0916f08fda2b9e9d30b))
* 优化模糊音 ([c9d439f](https://github.com/ji1360677347/rime_wanxiang/commit/c9d439ff5bedb1d75a8e45211d17a07628b49761))
* 优化统计 ([42d66ec](https://github.com/ji1360677347/rime_wanxiang/commit/42d66ec76fd7e908c86cdcdfafbed9c1ff2b566e))
* 优化英文句子的一些问题 ([281ccad](https://github.com/ji1360677347/rime_wanxiang/commit/281ccad98e20931d9928e3fb4a4b448f7d5dc5d2))
* 优化英文大写格式化中对于预设英文句子的正确处理 ([d18c21f](https://github.com/ji1360677347/rime_wanxiang/commit/d18c21f2c2374278c400892db864c6180a518c44))
* 优化英文智能加空格逻辑 ([85ceceb](https://github.com/ji1360677347/rime_wanxiang/commit/85cecebea6346552b2265c43b73b1818b9cdb859))
* 优化超级注释，移除掉分隔符转换的代码，其他性能优化 ([5345d29](https://github.com/ji1360677347/rime_wanxiang/commit/5345d291eab15c56984ace6b1b6c16711fdddedc))
* 优化辅助码及拆分储存方式 ([5fc8b5b](https://github.com/ji1360677347/rime_wanxiang/commit/5fc8b5bbd25fba4b11dc21d91d49193435ba98cb))
* 优化输入统计 ([749ccd1](https://github.com/ji1360677347/rime_wanxiang/commit/749ccd1cbd04fa78e657abaf259176b5e2c19a43))
* 优化预测S级导入的保护策略 ([a28c698](https://github.com/ji1360677347/rime_wanxiang/commit/a28c6986982f1814c3841ca0d7a6c1949a307022))
* 优化预测的时候允许逗号句号顿号等直接上屏不带上预测候选 ([fc89f6f](https://github.com/ji1360677347/rime_wanxiang/commit/fc89f6f98f722cd287c3c9920a0c799e818e3f8e))
* 修复lookup残留的一个微妙的bug ([86dc319](https://github.com/ji1360677347/rime_wanxiang/commit/86dc3191647899b2b40122beba472e0c3d88f66a))
* 修复replacer若干bug ([ed92349](https://github.com/ji1360677347/rime_wanxiang/commit/ed923499fab643c9c791757238e05bdc525912c0))
* 修复两个插件兼容lua5.5语法 ([a5e8312](https://github.com/ji1360677347/rime_wanxiang/commit/a5e8312550e8c2b333f2b786156216ef3a37d211))
* 修复历史残留的t9模式判断错误 ([581ae39](https://github.com/ji1360677347/rime_wanxiang/commit/581ae394347e57a89f95e910cf39bd6f9cce0228))
* 修复因t9转换数字加载引发的bug导致iOS内存短时间增长从而引发系统gc的问题 ([ebce0bb](https://github.com/ji1360677347/rime_wanxiang/commit/ebce0bb6ba7b67fece60329a48f33fc9ed90cfbe))
* 修复字符级过滤句子兜底的一个错误 ([14cc722](https://github.com/ji1360677347/rime_wanxiang/commit/14cc72296e16448ddfcd56dfab1739ae7706bab3))
* 修复手动排序数据不能参与到真实位置的符号包裹 ([245e2ff](https://github.com/ji1360677347/rime_wanxiang/commit/245e2ff6d8d77c33501666bfce160616bb337891))
* 修复文本格式化一些逻辑漏洞 ([6088975](https://github.com/ji1360677347/rime_wanxiang/commit/6088975a385d5a54ea02d5a3804d48835e63df56))
* 修复简码与用户词碰撞以及英文加空格导致的text无法去重的问题 ([540c628](https://github.com/ji1360677347/rime_wanxiang/commit/540c6287cb323c3cb50eb7181d5ef8abea47491e))
* 修复简码前置因系统差异导致的排序异常 ([1b47cfd](https://github.com/ji1360677347/rime_wanxiang/commit/1b47cfd86dc7aef9fb9acfae35a1cf4b82a13ec9))
* 修复英文句子的分隔符兜底问题 ([2e66d86](https://github.com/ji1360677347/rime_wanxiang/commit/2e66d867201f5930ef75e4d8dcd68cd52fb2e4e5))
* 修复虎码问题 ([d28375a](https://github.com/ji1360677347/rime_wanxiang/commit/d28375a1fc21dfed189719d82cc750e5980f9bf6))
* 修改部分墨奇辅助码 ([f0322bf](https://github.com/ji1360677347/rime_wanxiang/commit/f0322bf2392cce34f14cc9fc7246d8ce519f7dd6))
* 修正蓝天双拼转写 ([5f9618e](https://github.com/ji1360677347/rime_wanxiang/commit/5f9618eec981560a86dc912a82c3948c7641da95))
* 候选格式化回车前默认增加了零宽空格以应对electron类软件把尾字拖到内容最后一行的问题 ([f9e4d03](https://github.com/ji1360677347/rime_wanxiang/commit/f9e4d03550844653793197bbe8bcdeb7144ddab5))
* 先修复一个版本英文在中文中句子问题，其他问题后续再修复 ([c7c748d](https://github.com/ji1360677347/rime_wanxiang/commit/c7c748d0bf981a3130d2a5af6b4b9c8baa57621a))
* 全面恢复小狼毫皮肤配色 ([e2c62b8](https://github.com/ji1360677347/rime_wanxiang/commit/e2c62b803c2f6193a3e8ab6096675e67437fd842))
* 兼容lua5.5语法 ([991e8da](https://github.com/ji1360677347/rime_wanxiang/commit/991e8dad5432771a1a1704202236a727ab700b01))
* 删除英文候选后面的派生逻辑已经迁移到english对应lua，这里移除相关逻辑 ([4c696bd](https://github.com/ji1360677347/rime_wanxiang/commit/4c696bd15d9f5616dd39023b7fcd0383fedd9c9f))
* 删除英文相关逻辑继续优化 ([2efddd9](https://github.com/ji1360677347/rime_wanxiang/commit/2efddd937d29d896bd2e13ed7e6ff4edf5dabe9e))
* 升级ci ([77b1744](https://github.com/ji1360677347/rime_wanxiang/commit/77b1744f8db80d5b733278e692bf54dc65d48262))
* 反查允许使用;作为编码 ([1b5237a](https://github.com/ji1360677347/rime_wanxiang/commit/1b5237ae17f3a791d4ba45b77769d5e796da8f8e))
* 取消一些安全闭包，有问题就要暴露出来 ([8b68cf9](https://github.com/ji1360677347/rime_wanxiang/commit/8b68cf9e0a4d406d2500bd89b8c86e51d04019c3))
* 变更参数 ([9ad34f7](https://github.com/ji1360677347/rime_wanxiang/commit/9ad34f7add8c887bf810e39928fbd3404c6c3f6e))
* 变更字符级过滤兜底的preedit呈现形式统一逻辑 ([bafb5ed](https://github.com/ji1360677347/rime_wanxiang/commit/bafb5ed4c216032f7a2c4f0c91b4729d6aee65ef))
* 变更计算插件type ([661a4ca](https://github.com/ji1360677347/rime_wanxiang/commit/661a4ca8b0b01895bb74fb00c6d071cecb7d40ea))
* 同步新参数到简纯皮肤 ([33ba551](https://github.com/ji1360677347/rime_wanxiang/commit/33ba5515284bd6775cf7489564535de5e32b99a8))
* 同步移除英文造词逻辑 ([a13985a](https://github.com/ji1360677347/rime_wanxiang/commit/a13985a24fc046e4a360a07a48314b916419edcd))
* 回车以拦截并输出换行来尝试 ([395ac0e](https://github.com/ji1360677347/rime_wanxiang/commit/395ac0e77b97e4ee3d5e1bbda4f237fc70ddc3d8))
* 回退英文造句在中文中的使用，还是有很多问题存在，不能做到100%完美 ([86b6225](https://github.com/ji1360677347/rime_wanxiang/commit/86b6225227c7efad8494903a81963184a215a623))
* 在确认英文靠前的情形下干掉无效的补全候选 ([0221fcf](https://github.com/ji1360677347/rime_wanxiang/commit/0221fcfdff171fabb0c99e31aff8a50812b2f271))
* 增加清空表后主动gc ([70d4aa9](https://github.com/ji1360677347/rime_wanxiang/commit/70d4aa93fca79c29f4585de3d5387c712b4350a5))
* 处理一些声明细节 ([97da72a](https://github.com/ji1360677347/rime_wanxiang/commit/97da72a433e6f2c4ce525848a553a56eee077048))
* 字符集过滤性能优化 ([2cc3c04](https://github.com/ji1360677347/rime_wanxiang/commit/2cc3c046aacfb15cd5c80ab8b45575f2cc257da7))
* 字符集过滤词库中的生僻字词组不删除只在句子中避免生僻字干扰 ([3bac4b0](https://github.com/ji1360677347/rime_wanxiang/commit/3bac4b0954a017eb5360fb68ef37bef3e4b64b7d))
* 安全调用userdb ([5b28dc9](https://github.com/ji1360677347/rime_wanxiang/commit/5b28dc9ce6a9b3c4555b6427b82fb34c306563e2))
* 完善英文符号引用 ([6ab2b45](https://github.com/ji1360677347/rime_wanxiang/commit/6ab2b458926096457a62b17e6273a2df98232131))
* 完善英文符号引用 ([ea451a2](https://github.com/ji1360677347/rime_wanxiang/commit/ea451a2a2cb5c6e02405ffd65a786543f2830bf8))
* 完善部分声明 ([e163aa2](https://github.com/ji1360677347/rime_wanxiang/commit/e163aa242a2b3cb88bda77198062570c894f0fd9))
* 将预测手机上有两种模式选择，而pc端只能上下文调频，这种硬性的分离避免了无意义的pc端使用弹出模式，不仅不好用还因lua限制input占位导致了很多问题，所以纠正到正确的道路上来 ([aae385b](https://github.com/ji1360677347/rime_wanxiang/commit/aae385bfec117c7f88f1e136128c6c1ec1ace524))
* 微调单字简码 ([56d858e](https://github.com/ji1360677347/rime_wanxiang/commit/56d858e1472f1169c746a54def5caec7f93204fe))
* 微调模型参数，基于多类型语料测试科学取值 ([13acc51](https://github.com/ji1360677347/rime_wanxiang/commit/13acc516a4e90e67a0e035d8e718aaa4ccea0d0c))
* 快符t/默认设置为制表符了 ([0d4eec1](https://github.com/ji1360677347/rime_wanxiang/commit/0d4eec1e7631dd55de27d2fc281a48639fec6e67))
* 恢复之前误删除的代码，删除英文句子后面派生的无意义句子 ([0da40dd](https://github.com/ji1360677347/rime_wanxiang/commit/0da40dd0d44298fd0ad664d8edf8da850208e6fc))
* 恢复保护翻译器挂在的方法 ([3b11f72](https://github.com/ji1360677347/rime_wanxiang/commit/3b11f72debc05dc819f29023829b8d162c4b85bd))
* 恢复快符制表符 ([3ea80ef](https://github.com/ji1360677347/rime_wanxiang/commit/3ea80efc173c2cfa8faa4bd8eb1d3dd10423e7d4))
* 恢复流式加载数据并解决前缀key问题 ([f219fbf](https://github.com/ji1360677347/rime_wanxiang/commit/f219fbfb2286eec956373f9316fc4641f5052135))
* 恢复误删除函数 ([05cc3bd](https://github.com/ji1360677347/rime_wanxiang/commit/05cc3bd69be5b11d5984a91f6e83c3375e3698c2))
* 恢复预测的多条记录能力 ([1cad8c4](https://github.com/ji1360677347/rime_wanxiang/commit/1cad8c43db90bbc07ef6397f42f5b1f72b54a544))
* 手动调序对英文加空格做了一些兼容，写入时去掉前后空格 ([2a07c75](https://github.com/ji1360677347/rime_wanxiang/commit/2a07c757bee6f19f51357c5a8dd4700d29f9231f))
* 排除回退键在mac上面的限制 ([9062626](https://github.com/ji1360677347/rime_wanxiang/commit/9062626b494ff13862b29e36935d3f5112c2e37e))
* 数据库关闭前gc释放对象 ([164c62b](https://github.com/ji1360677347/rime_wanxiang/commit/164c62b4e100461f890a2193048ef171dbd1c37e))
* 数据库采用私有计数复用 ([b85dd4f](https://github.com/ji1360677347/rime_wanxiang/commit/b85dd4f76b6e1fff5647d46e5e4f16f3c7851634))
* 文本格式化同步新增周相关占位 ([f69e853](https://github.com/ji1360677347/rime_wanxiang/commit/f69e8534c08b70107988f77fdb0521d0a88745f3))
* 时间新增周相关占位 ([75b7049](https://github.com/ji1360677347/rime_wanxiang/commit/75b704961f98dcd8cbfff1a13ef7902910bce29c))
* 更新文档 ([8ac0f2c](https://github.com/ji1360677347/rime_wanxiang/commit/8ac0f2c10a628b2a1151eb60e5fde6412791f946))
* 更新模型参数 ([131bb93](https://github.com/ji1360677347/rime_wanxiang/commit/131bb93da2fb5eff1524e3d9494bef0b4cf24791))
* 根目录置顶词优先于abbrev置顶词 ([cbdd552](https://github.com/ji1360677347/rime_wanxiang/commit/cbdd552b902f8f3f7630921afc8f849119b04acb))
* 格式化yaml ([262218c](https://github.com/ji1360677347/rime_wanxiang/commit/262218c65810da9bb7c9c9ebb2fdbd9bd7b54e65))
* 格式化权限与换行 ([b0d7163](https://github.com/ji1360677347/rime_wanxiang/commit/b0d71637ebf4a609aab3a3f54ff41204ae78390e))
* 涉及到数据加载的统一调用函数进行用户目录与系统目录的回退并使用相对路径 ([703f799](https://github.com/ji1360677347/rime_wanxiang/commit/703f799f07c74f9f9af3a5202c7170fe814c9b74))
* 添加deepin pr自动化 ([19cd8a5](https://github.com/ji1360677347/rime_wanxiang/commit/19cd8a5606605aa48de8d0b953f40ea040327c8d))
* 添加user_table为字符集过滤豁免 ([8620bfb](https://github.com/ji1360677347/rime_wanxiang/commit/8620bfb64c5a5c869f81d4c3022ab7bede3872f2))
* 添加元书pc信息 ([11c2f5e](https://github.com/ji1360677347/rime_wanxiang/commit/11c2f5ef6a43e6285aa71c93f210c74aeb8c0ae3))
* 添加流水线排除项 ([7e229ef](https://github.com/ji1360677347/rime_wanxiang/commit/7e229eff6ec8253ec59d71513184f5b043468a2c))
* 特殊tag下不进行空码兜底 ([982c4a4](https://github.com/ji1360677347/rime_wanxiang/commit/982c4a4ded77e29030f277db305e4ba16dee64ce))
* 用户词预测组件，如果是弹出，依旧限制上文宽度大于2,如果是上下文则放宽到1 ([12ba992](https://github.com/ji1360677347/rime_wanxiang/commit/12ba99298fd97e3aa4d79fb54314d812320fde1e))
* 由于luagc慢，加载数据的时候不再管理重复key ([13b714f](https://github.com/ji1360677347/rime_wanxiang/commit/13b714fdbc5fec5cf3e640e461a68e4c4fde83ef))
* 移动端判断增加两个前端 ([1768768](https://github.com/ji1360677347/rime_wanxiang/commit/176876868212496cc4da5b50440d1216015e08a2))
* 移除an纠错转写 ([d35658c](https://github.com/ji1360677347/rime_wanxiang/commit/d35658c5e7511cf8dfacfa781a54176043bdaa0a))
* 移除PR造成的句号问号作为编码的配置 ([8800663](https://github.com/ji1360677347/rime_wanxiang/commit/8800663b29a9ef15b340a996e2c76a15cecae1df))
* 移除三码两字类型简码 ([3994a56](https://github.com/ji1360677347/rime_wanxiang/commit/3994a5639eb902c105482f63aa4f0fbc71a4ed02))
* 移除不必要的日志 ([734364f](https://github.com/ji1360677347/rime_wanxiang/commit/734364f43fe53040f552356d1d7890e30fd867cf))
* 移除之前将鼠须管强制认定为移动端的代码，鼠须管用户还是需要观察有问题反馈 ([edc1e44](https://github.com/ji1360677347/rime_wanxiang/commit/edc1e44c6b62d87e469c64149a9abe95c96f85ca))
* 移除全拼ian-iam的模糊 ([e0ea8e0](https://github.com/ji1360677347/rime_wanxiang/commit/e0ea8e04f07e1a79923d8bbdfd468925704ee2cf))
* 移除单字固定还是由用户自定义吧 ([f89defd](https://github.com/ji1360677347/rime_wanxiang/commit/f89defd74207a2fa0812442d9641c1747565d8a9))
* 移除太极相关代码 ([adf0fb0](https://github.com/ji1360677347/rime_wanxiang/commit/adf0fb0e129f088a7da43f86b9fa6a257fb76a75))
* 移除计算器引导的多余配置 ([833c7e6](https://github.com/ji1360677347/rime_wanxiang/commit/833c7e676110df24438d1cc4e9e58999fdb6b618))
* 稍稍优化初始化懒加载 ([d5a33e7](https://github.com/ji1360677347/rime_wanxiang/commit/d5a33e7ce64d7c08b32a3f11766e347c69aa5aea))
* 紧急修复pure版本词库引用 ([37d64a1](https://github.com/ji1360677347/rime_wanxiang/commit/37d64a1aeba82d2056e4a6b303434aa2aa89c1a8))
* 紧急变更预测方案去掉了lua关于符号的拦截，改为通过key_binder处理 ([d9defd0](https://github.com/ji1360677347/rime_wanxiang/commit/d9defd08d3fd47003b8c4cc081ee6530915809f0))
* 细化punct正则 ([64de4aa](https://github.com/ji1360677347/rime_wanxiang/commit/64de4aa7dc90d647cc30b84a4a329a0578f1af03))
* 经用户启发，replacer支持剔除掉手动分隔符的匹配简码 ([32775c7](https://github.com/ji1360677347/rime_wanxiang/commit/32775c7a7cf3451a700febfc42f47b1826d3f9c0))
* 脚本两处细节优化 ([c53829b](https://github.com/ji1360677347/rime_wanxiang/commit/c53829b109e6aa66a0c9b709f565cdbc01ded845))
* 若干脚本整体优化性能和执行效率 ([e1b1514](https://github.com/ji1360677347/rime_wanxiang/commit/e1b1514d5bc17c8d489042a82a062410301bf08c))
* 英文replacer数据位置调整 ([2da4d4b](https://github.com/ji1360677347/rime_wanxiang/commit/2da4d4b4f2adc7d8fda27cefc8dc85f2c9f36f24))
* 英文方案增加全角半角开关 ([3ac622b](https://github.com/ji1360677347/rime_wanxiang/commit/3ac622b7b301e8ed21580a181a04b562464ab797))
* 英文方案增加导入symbol列表 ([244cbce](https://github.com/ji1360677347/rime_wanxiang/commit/244cbce27befb082b6b2688c6d4614665eee3e0c))
* 英文方案添加符号处理器 ([0e4be46](https://github.com/ji1360677347/rime_wanxiang/commit/0e4be462bc4f3df8c9cf4b8d697dbae02054f6e4))
* 英文造句时包含分隔符的处理逻辑 ([d861539](https://github.com/ji1360677347/rime_wanxiang/commit/d861539df1ae75a8ebcbd677a463921966636829))
* 补齐了遗漏的一些配置 ([f9e924d](https://github.com/ji1360677347/rime_wanxiang/commit/f9e924d1a83f435c244029767cc8f667cd8061f8))
* 补齐英文方案emoji开关 ([82a261c](https://github.com/ji1360677347/rime_wanxiang/commit/82a261c9c10aa08185b9be24a9ec42c64d94aa5c))
* 调整一些示例细节 ([cb81c21](https://github.com/ji1360677347/rime_wanxiang/commit/cb81c211b3e7b657d1da5c6c52afbe57fc84c077))
* 调整了一下方案配置结构 ([8c61f50](https://github.com/ji1360677347/rime_wanxiang/commit/8c61f5087be35a073ebef11a0db870183b2a2d44))
* 调整参数 ([38a2586](https://github.com/ji1360677347/rime_wanxiang/commit/38a25862bcff4db9208dcc80e753788b7d60bcd3))
* 调整后重新上线英文造词 ([4c76171](https://github.com/ji1360677347/rime_wanxiang/commit/4c761716b65a21f182a7024522040178a9d7a4f9))
* 调整模型参数 ([f0ab68f](https://github.com/ji1360677347/rime_wanxiang/commit/f0ab68f0094a87df5bfb61b19dc7487799f1b923))
* 调整转写规则 ([175c1cd](https://github.com/ji1360677347/rime_wanxiang/commit/175c1cd7c8164a0e994df5b1cf89d68c84c0588d))
* 超级替换合并为单一缓存表 ([5db3c99](https://github.com/ji1360677347/rime_wanxiang/commit/5db3c99221c83bc595bc2ab1ebe74f03eb5075f7))
* 超级替换重构后功能的恢复和修复 ([2f175c9](https://github.com/ji1360677347/rime_wanxiang/commit/2f175c9764cf3031f6dd983f9fcdc59c4f22b891))
* 转写规则同步首道变更 ([5526229](https://github.com/ji1360677347/rime_wanxiang/commit/552622954c2059d64d01ac869da692446db04b18))
* 输入统计仅db数据库可用时才进行缓存操作 ([676e4ac](https://github.com/ji1360677347/rime_wanxiang/commit/676e4ac77b2cae44e2396391913d8e1ea908adc8))
* 还是通过lua open读取default拿清单这样既能避免旧版本librime不可用也能避免W日志的频繁输出 ([49d5689](https://github.com/ji1360677347/rime_wanxiang/commit/49d56893b1324b12ad502c39e0afe474b8e77ea5))
* 重新思考后将pr的复杂性较高的C引导合成compose符号序列改成了使用/模式symbol承载的方式，这样可以避免字母引导引发的冲突，可以复用/符号，最关键的是复用符号处理在整个逻辑序列里有着不好描述的得天独厚的逻辑解构，比lua实现存在更少的问题也不用把txt加载成lua表，总之很舒服 ([df2d63b](https://github.com/ji1360677347/rime_wanxiang/commit/df2d63b1728fb2b057ab5e4ab882c5259dd378ae))
* 预测代码持续优化 ([09ba25b](https://github.com/ji1360677347/rime_wanxiang/commit/09ba25b04e3c6dea998cd15f1e0828767f4648ce))
* 预测配置改为互斥的两种模式，对应的patch需要自行修改 ([62887f8](https://github.com/ji1360677347/rime_wanxiang/commit/62887f888e03379353beb27f8c79747368bbdbbd))
* 黄霄雲的雲加入小字集白名单 ([34382b9](https://github.com/ji1360677347/rime_wanxiang/commit/34382b9c78897eba3299de0aed7d96b2d93aa3ad))
* 默认关闭回退12词组交换的逻辑,让有需求且理解的人提问后开启 ([872e493](https://github.com/ji1360677347/rime_wanxiang/commit/872e4936dd44012435264f051cfaa719baf95520))
* 默认注释掉元书t9处理器，现在九键前端增多，使用者自己patch开启 ([16cd5a0](https://github.com/ji1360677347/rime_wanxiang/commit/16cd5a08003ad582763cdaf74a4a6e43a543963c))


### 💅 重构

* **input_statistics:** 重构统计算法 ([b47f51a](https://github.com/ji1360677347/rime_wanxiang/commit/b47f51a1461b84ac2fd82f583458cffd19013060))
* **shijian.lua:** 大规模重构代码质量，增强复用懒加载，新增/ed单独候选序列，新增全拼写单词月和前缀单词月变量，在ed中得到应用，同时其他sj、rq等也都可以通过配置设置新增候选样式 ([527069e](https://github.com/ji1360677347/rime_wanxiang/commit/527069e75f94e99608a13411f8bf1f00690b1cbe))
* **super_symbols:** add configurable triggers and fix modifier parsing ([06e136b](https://github.com/ji1360677347/rime_wanxiang/commit/06e136bb161251f3021e8d4226bc578e8007378d))
* **super_symbols:** optimize data loading and matching logic ([0fc7d0f](https://github.com/ji1360677347/rime_wanxiang/commit/0fc7d0f3a270fc8b45f7863a2a5158871da4990b))
* **super_symbols:** remove comments and load data in init ([a9582c4](https://github.com/ji1360677347/rime_wanxiang/commit/a9582c4e2b50d1758eba9c463da09ade4c51d9ba))
* **super_symbols:** rewrite matching with dot-chained order-independent logic ([4873781](https://github.com/ji1360677347/rime_wanxiang/commit/4873781636d11b8063695d7d7c909547eff30b73))
* 全新重构的U码转换功能 ([3ae7a90](https://github.com/ji1360677347/rime_wanxiang/commit/3ae7a90897982f108b5b0af67749ea6c0422d8a3))
* 对使用数据库的几个插件进行重构，使用公共处理库改写，复用userdb格式，原来因为数据库专用于用户词，对格式设计较为定向，其同步程序也专用于这个格式的解析，这就导致了复杂的数据库需求需要折叠到其他路径，但折叠又面临一个问题，当app打包了你的脚本后用户目录为空，路径不存在就无法创建数据库从而报错，本次也是顶着压力尽可能地想办法复用用户词数据库的格式，不受影响的脚本有，输入统计，反而能统计多个设备的数据了，超级替换简单的数据结构改变，tips也是简单的数据结构变化，难点在于预测、排序这两个，主要测试能否复用同步逻辑，如果存在合并问题其实也可以手动迁移数据依赖同步导入，只是不去依赖自动合并。另有好消息手动排序改变了算法，去掉了依赖时间的排序逻辑在时间复杂度上面大幅度降低 ([5faa37b](https://github.com/ji1360677347/rime_wanxiang/commit/5faa37b99656409b3941e50debe637df62874594))
* 重构英文限流位置提升性能 ([f01947d](https://github.com/ji1360677347/rime_wanxiang/commit/f01947d59d06c5d7d572ea98e301c78c34235591))
* 金额大写全新重构为数字转换lua提供更多转换结果 ([a07d61e](https://github.com/ji1360677347/rime_wanxiang/commit/a07d61eca1a7350b26c10ab9a2b4b575641cdfc2))


### 📖 文档

* **wanxiang:** release 17.3.0 ([296f90d](https://github.com/ji1360677347/rime_wanxiang/commit/296f90d17e6b587b6fabcd661686e66372f2afaa))
* 修改文档 ([f0aacad](https://github.com/ji1360677347/rime_wanxiang/commit/f0aacadf63ac610f6270e3738f4f2d53d9e62ec2))
* 修正文档 ([3a359b4](https://github.com/ji1360677347/rime_wanxiang/commit/3a359b4faae639a1ce898ac643e1f471c1250d6e))
* 变更文档 ([2c2ca9d](https://github.com/ji1360677347/rime_wanxiang/commit/2c2ca9dc308f698ea2c9bd4ca0a84a6a2e4669f8))
* 变更版本 ([bad6a9a](https://github.com/ji1360677347/rime_wanxiang/commit/bad6a9a49dfb33155a9cfc71df8c72c6401892d0))
* 文档迁移到仓库，建立与仓库强关联 ([1e0dcd3](https://github.com/ji1360677347/rime_wanxiang/commit/1e0dcd38321223e63d02e9bd7771e1d483d0b4ac))
* 更新文档 ([5e1dace](https://github.com/ji1360677347/rime_wanxiang/commit/5e1dace47243b39e4aa48731225d222bdbae7f59))
* 更新文档 ([7221df6](https://github.com/ji1360677347/rime_wanxiang/commit/7221df6a5274595f964445daa5e2dc1d683e53fa))
* 更新文档 ([8913fc6](https://github.com/ji1360677347/rime_wanxiang/commit/8913fc67a2e0a175126a7afafbe4fc355c7b1567))
* 更新文档 ([e1cd878](https://github.com/ji1360677347/rime_wanxiang/commit/e1cd87802f7dedc1311b98d3310a9624e7895629))
* 简纯使用编译后文件 ([a934f87](https://github.com/ji1360677347/rime_wanxiang/commit/a934f8705687f587066556ef0295bc057592553c))


### 🤖 持续集成

* auxcode采用黑名单形式，便于添加额外的词库 ([f195ce0](https://github.com/ji1360677347/rime_wanxiang/commit/f195ce02039fb338ccd9254aa06a90ce5720799f))
* del ([f4b263a](https://github.com/ji1360677347/rime_wanxiang/commit/f4b263a28c32290f339fbcb1d09b016b0147d1b6))
* update ([dd0c171](https://github.com/ji1360677347/rime_wanxiang/commit/dd0c171dfc436d49a8318c579338a45041b77d8c))
* 主题文件直接释放到build ([6cd2d15](https://github.com/ji1360677347/rime_wanxiang/commit/6cd2d15845c07bd8aa08400764f63ac29673a9d4))
* 修复 ([6524b2f](https://github.com/ji1360677347/rime_wanxiang/commit/6524b2fb67cdd066213041b5706c88f3466dc7f5))
* 合并词库提交 ([e3e7513](https://github.com/ji1360677347/rime_wanxiang/commit/e3e7513b951e67c878e70a444d880b81a49fa176))
* 同文自动打包不打包模型，需单独下载 ([3e199da](https://github.com/ji1360677347/rime_wanxiang/commit/3e199da6feade4e68e697f2181b5536762c8a772))
* 移除排除项 ([b7c2605](https://github.com/ji1360677347/rime_wanxiang/commit/b7c2605ad7f8d23da8597476cae20777c9acfd56))
* 移除排除项 ([214ce95](https://github.com/ji1360677347/rime_wanxiang/commit/214ce95650e6303b0524e8b1a5153bfef7806d2d))
* 简化release提示信息 ([b021797](https://github.com/ji1360677347/rime_wanxiang/commit/b0217974074f7ee1660f749e5d46e1edb884d36a))
